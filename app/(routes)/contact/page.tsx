              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="https://twitter.com" className="text-gray-600 hover:text-skynex-blue dark:text-gray-300 dark:hover:text-skynex-accent">
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold mb-2">What services does SKYNEX offer?</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold mb-2">How can I get started with SKYNEX's tools?</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold mb-2">Does SKYNEX offer custom development services?</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold mb-2">Where are SKYNEX's offices located?</h3>
              <p className="text-gray-600 dark:text-gray-300">
