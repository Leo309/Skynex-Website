        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg dark:prose-invert">
              ...
              <p>
                Our Services may contain interactive features that allow users to post, submit, publish, display, or transmit content or materials. Any content you post to our Services will be considered non-confidential and non-proprietary. By providing any content on our Services, you grant us and our affiliates and service providers a nonexclusive, royalty-free, perpetual, irrevocable, and fully sublicensable right to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, and display such content throughout the world in any media.
              </p>
              
              <h2>7. Payment Terms</h2>
              <p>
                Certain Services may require payment. By using such Services, you agree to pay all fees and charges associated with your account on a timely basis and in accordance with the fees, charges, and billing terms in effect at the time. All payments must be made in the currency specified, and you are responsible for any applicable taxes.
              </p>
              ...
              <p>
                THE SERVICES ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS, WITHOUT ANY WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
              </p>
              <p>
              ...
              <p>
                These Terms and your use of the Services shall be governed by and construed in accordance with the laws of British Columbia, Canada, without regard to its conflict of law principles. Any legal suit, action, or proceeding arising out of or related to these Terms or the Services shall be instituted exclusively in the courts of British Columbia, although we retain the right to bring any suit, action, or proceeding against you for breach of these Terms in your country of residence or any other relevant country.
              </p>
