      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-lg mb-4 text-gray-900 dark:text-white">Intelligent Tools for Global Business</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">AI-Powered Tools</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">SaaS Delivery</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Data Intelligence</h3>
              <p className="text-gray-600 dark:text-gray-300">
